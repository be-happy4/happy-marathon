...
export enum DICT_TYPE {
  ...
  // ========== Marathon - 马拉松模块 ==========
  GAME_TYPE = 'game_type', // 赛事类型
  GAME_STATUS = 'game_status', // 赛事状态
  GAME_TAG = 'game_tag', // 赛事标签
  GAME_REGISTRATION_STATUS = 'game_registration_status', // 个人报名状态
  GAME_WORLD_ATHLETICS_LABEL_LEVEL = 'game_world_athletics_label_level', // 国际田联标牌等级
  GAME_CHINA_ROAD_RUN_GAME_LEVEL = 'game_china_road_run_game_level', // 中国田联路跑赛事等级
  GAME_CATEGORY_TYPE = 'game_category_type' // 组别类型
}
